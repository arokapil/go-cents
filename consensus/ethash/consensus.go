...
import (
	...
	"github.com/arokapil/go-cents/common"
	"github.com/arokapil/go-cents/common/math"
	"github.com/arokapil/go-cents/consensus"
	"github.com/arokapil/go-cents/consensus/misc"
	"github.com/arokapil/go-cents/core/state"
	"github.com/arokapil/go-cents/core/types"
	"github.com/arokapil/go-cents/params"
...
var (
	...
	FrontierBlockReward    					*big.Int = big.NewInt(5e+18) // Not used will be removed in furture CENTS update.
	ByzantiumBlockReward   					*big.Int = big.NewInt(3e+18) // Not used will be removed in furture CENTS update.
)

//  CENTS Variables
var (
	egem0BlockReward                *big.Int = big.NewInt(8e+18)              //  8 CENTS Block reward in wei for successfully mining a block.     (ERA0)
	egem1BlockReward                *big.Int = big.NewInt(4e+18)              //  4 CENTS Block reward in wei for successfully mining a block.     (ERA1)
	egem2BlockReward                *big.Int = big.NewInt(2e+18)              //  2 CENTS Block reward in wei for successfully mining a block.     (ERA2)
	egem3BlockReward                *big.Int = big.NewInt(1e+18)              //  1 CENTS Block reward in wei for successfully mining a block.     (ERA3)
	egem4BlockReward                *big.Int = big.NewInt(500000000000000000) //  0.5 CENTS Block reward in wei for successfully mining a block.   (ERA4)
	egem5BlockReward                *big.Int = big.NewInt(250000000000000000) //  0.25 CENTS Block reward in wei for successfully mining a block.  (ERA5)
	egem6BlockReward                *big.Int = big.NewInt(125000000000000000) //  0.125 CENTS Block reward in wei for successfully mining a block. (ERA6)
	egem0DevReward                  *big.Int = big.NewInt(250000000000000000) //  Era0 1  CENTS per block.
  egem1DevReward								  *big.Int = big.NewInt(187500000000000000) //  Era1 0.75 CENTS per block.
	egem2DevReward                  *big.Int = big.NewInt(125000000000000000) //  Era2 0.5 CENTS per block.
	egem3DevReward								  *big.Int = big.NewInt(62500000000000000)  //  Era3 0.25 CENTS per block
	egem4DevReward                  *big.Int = big.NewInt(25000000000000000)  //  Era4 0.1 CENTS per block.
	egem5DevReward                  *big.Int = big.NewInt(12500000000000000)  //  Era5 0.05 CENTS per block.
	egem6DevReward                  *big.Int = big.NewInt(6250000000000000)   //  Era6 0.025 CENTS per block.
