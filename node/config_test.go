...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "cents.ipc", false, filepath.Join(os.TempDir(), "cents.ipc")},
		{"data", "cents.ipc", false, "data/cents.ipc"},
		{"data", "./cents.ipc", false, "./cents.ipc"},
		{"data", "/cents.ipc", false, "/cents.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "cents.ipc", true, `\\.\pipe\cents.ipc`},
		{"data", "cents.ipc", true, `\\.\pipe\cents.ipc`},
		{"data", `\\.\pipe\cents.ipc`, true, `\\.\pipe\cents.ipc`},
	}
